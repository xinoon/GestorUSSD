...
declare function xf:IN_XQ_NextelActiveProduct_OutInfoCliente($nroCelular as xs:string,
...
xf:IN_XQ_NextelActiveProduct_OutInfoCliente($nroCelular,
    $id_prod,
    $id_prod_service,
