...
(:: pragma bea:global-element-parameter parameter="$searchBalancesICC_response1" element="ns0:searchBalancesICC-response" location="../Specifications/serviceSearchPrepagoICC-response.xsd" ::)
(:: pragma bea:global-element-return element="ns1:unitTotalExtendidaFullResponse" location="../Specifications/PrepaidWaveService.xsd" ::)
