...
(:: pragma bea:global-element-parameter parameter="$searchBalancesICC_request1" element="ns1:searchBalancesICC-request" location="../WSDL/searchBalancesICC-request.xsd" ::)
